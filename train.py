...
def main(train_set, learning_rate, n_epochs, beta_0, beta_1, batch_size, num_workers, hidden_size,
    ...
    for epoch in range(n_epochs):
        ...
        for idx, (true_batch, _) in enumerate(train_dataloader):
            ...
            fake_disc_result = disc.forward(fake_batch)

            disc_train_loss = BCE_loss(true_disc_result.squeeze(), true_target) + \
                              BCE_loss(fake_disc_result.squeeze(), fake_target)
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--display_result_every', type=int, default=640)
    argparser.add_argument('--checkpoint_interval', type=int, default=3200)
